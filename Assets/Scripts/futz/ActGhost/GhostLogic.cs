...
namespace futz.ActGhost
{
	public static class GhostLogic
	{
		...
		public static async UniTask BeginRound(GhostActivity act)
		{
			var fig = act.Fig;
		...
		public static void AssignClues(GhostActivity act)
		{
			var fig = act.Fig;
		...
		public static void AssignCards(GhostActivity act, GhostActor actor)
		{
			var fig = act.Fig;
		...
		static void CheckClueCount(GhostActivity act)
		{
			var allSubmitted =
		...
		public static async UniTask BeginGuessing(GhostActivity act)
		{
			var fig = act.Fig;
		...
		static void CheckGuessCount(GhostActivity act)
		{
			var allSubmitted =
		...
		public static async UniTask NextGuessing(GhostActivity act)
		{
			var fig = act.Fig;
		...
		static async UniTask ShowGuessResult(GhostActivity act)
		{
			var fig = act.Fig;
			var actors = act.Actors.Current;
